...
class Local(models.Model):
	...
	mesesServicio = models.IntegerField("Meses de servicio")
	...
	altitud = models.DecimalField("Altitu del gps", max_digits=8, decimal_places=6, blank=True)
	latitud = models.DecimalField("Latitud del gps", max_digits=8, decimal_places=6, blank=True)
